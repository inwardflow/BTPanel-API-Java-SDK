...
import net.heimeng.sdk.btapi.v2.api.BtApi.HttpMethod;
import net.heimeng.sdk.btapi.v2.config.BtSdkConfig;
import net.heimeng.sdk.btapi.v2.exception.BtApiException;
import net.heimeng.sdk.btapi.v2.exception.BtNetworkException;
import net.heimeng.sdk.btapi.v2.interceptor.RequestContext;
...
public class DefaultBtClient implements BtClient, AutoCloseable {
    ...
    private <T> void processResponse(
        ...
        if (response.statusCode() >= 200 && response.statusCode() < 300) {
            @SuppressWarnings("unchecked")
            T result = (T) api.parseResponse(response.body());
