 ...
 * @since 2.0.0
 */
public class CloseWebsitePasswordApi extends BaseBtApi<BtResult<Boolean>> {
    ...
    /**
     * 构造函数，创建一个新的CloseWebsitePasswordApi实例
     */
    ...
    public BtResult<Boolean> parseResponse(String response) {
        ...
        try {
            ...
            throw new BtApiException("Failed to parse close website password response: " + e.getMessage(), e);
        }
    }
}