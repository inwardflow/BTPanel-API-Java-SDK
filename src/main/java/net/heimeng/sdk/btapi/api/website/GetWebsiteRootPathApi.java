 ...
 * @since 2.0.0
 */
public class GetWebsiteRootPathApi extends BaseBtApi<BtResult<String>> {
    ...
    /**
     * 构造函数，创建一个新的GetWebsiteRootPathApi实例
     */
    ...
    public BtResult<String> parseResponse(String response) {
        ...
        try {
            ...
            throw new BtApiException("Failed to parse website root path response: " + e.getMessage(), e);
        }
    }
}